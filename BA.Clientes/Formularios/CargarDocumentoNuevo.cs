...
{
    public partial class CargarDocumentoNuevo : Form
    {
        ...
        public CargarDocumentoNuevo(string numero_documento, int Id_Perfil, string User)
        {
            Usuario_Login = User;
            PerfilRol = Id_Perfil;
            InitializeComponent();
            txtDocumentoCliente.Text = numero_documento;
        ...
        public void guardar()
        {
            ...
            validar_guardado = CargarDocumentos.GuardarDocumentosClientes(EntidadDocumentos);
        ...
        private void CargarDocumentoNuevo_Load(object sender, EventArgs e)
        {
            this.AutoSize = true;
