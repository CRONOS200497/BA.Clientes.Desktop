...
namespace BA.Clientes.Formularios
{
    public partial class AgendaClientes : Form
    {
        ...
        public AgendaClientes(int Id_Perfil, string User)
        {
            Usuario_Login = User;
            PerfilRol = Id_Perfil;
            InitializeComponent();
        ...
        {
            var load_documentos = Telefono.ConsultarTelefonosPorCliente(txtNumeroIdentificacionCliente.Text);
            dataGridView1.Rows.Clear();
        ...
        {
            var load_documentos = Correos.ConsultarCorreosPorCliente(txtNumeroIdentificacionCliente.Text);
            dataGridView2.Rows.Clear();
            if (load_documentos.Count > 0)
            {
                foreach (var d in load_documentos)
        ...
        {
            string Nombre_Formulario = "GuardarAgenda";
        ...
        public void GuardarTelefono()
        {
            ...
            EntidadTelefonos.Doc_Cliente = txtNumeroIdentificacionCliente.Text;
        ...
        public void GuardarCorreo()
        {
            ...
            EntidadCorreos.Doc_Cliente = txtNumeroIdentificacionCliente.Text;
        ...
        private void dataGridView2_Click(object sender, EventArgs e)
        {
            ...
            var Load_Novedad_Id = Correos.ConsultarCorreoPorId(id_Correo);
        ...
        private void dataGridView1_Click(object sender, EventArgs e)
        {
            ...
            var Load_Novedad_Id = Telefono.ConsultarTelefonoPorId(id_telefono);
        ...
        {
            string Nombre_Formulario = "ModificarAgenda";
            var Roles = Rol.ConsultarRolesPorPerfil(PerfilRol, Nombre_Formulario);
            if (Roles.Count > 0)
            {
                foreach (var d in Roles)
        ...
        public void ModificarTelefono()
        {
            ...
            bool ValidarRegistroTelefono = Telefono.ModificarTelefono(EntidadTelefonos);
            if (ValidarRegistroTelefono == true)
            {
                lblCreadoTelefono.Visible = true;
                lblCreadoTelefono.Text = EntidadTelefonos.Fecha_Insertado.ToString();
        ...
        public void ModificarCorreo()
        {
            ...
            bool ValidarRegistroCorreo = Correos.ModificarCorreo(EntidadCorreos);
            if (ValidarRegistroCorreo == true)
            {
                lblCreadoCorreo.Visible = true;
                lblCreadoCorreo.Text = EntidadCorreos.Fecha_Insertado.ToString();
        ...
        {
            string Nombre_Formulario = "EliminarAgenda";
            var Roles = Rol.ConsultarRolesPorPerfil(PerfilRol, Nombre_Formulario);
            if (Roles.Count > 0)
            {
                foreach (var d in Roles)
                    ...
                    if (d.Nombre_Rol.Equals(Nombre_Formulario))
                    {
                        ...
                        if (Confirmar_Modificacion_Telefono == DialogResult.OK)
                        {
                            ...
                            if (id_telefono >= 0)
                            {
                                ...
                                bool confirmar_eliminacion = Telefono.EliminarTelefono(EntidadTelefonos);
                        ...
                        if (Confirmar_Modificacion_Correo == DialogResult.OK)
                        {
                            ...
                            if (id_Correo >= 0)
                            {
                                ...
                                bool confirmar_eliminacion = Correos.EliminarCorreo(EntidadCorreos);
        ...
        private void AgendaClientes_Load_1(object sender, EventArgs e)
        {
            this.AutoSize = true;
