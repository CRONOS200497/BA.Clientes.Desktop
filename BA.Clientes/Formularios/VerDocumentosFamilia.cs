...
{
    public partial class VerDocumentosFamilia : Form
    {
        ...
        public VerDocumentosFamilia(int id_Archivo, int Id_Perfil, string User)
        {
            Usuario_Login = User;
            PerfilRol = Id_Perfil;
            InitializeComponent();
        ...
        {
            ruta = Documentos.AbrirDocumentoFamilia(id_Archivo);
        ...
        private void VerDocumentosFamilia_Load(object sender, EventArgs e)
        {
