...
{
    public partial class VerDocumentosClientes : Form
    {
        ...
        public VerDocumentosClientes(int id_Archivo, int Id_Perfil, string User)
        {
            Usuario_Login = User;
            PerfilRol = Id_Perfil;
            InitializeComponent();
        ...
        private void VerDocumentosClientes_Load(object sender, EventArgs e)
        {
