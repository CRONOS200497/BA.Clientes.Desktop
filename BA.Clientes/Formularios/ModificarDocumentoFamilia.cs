...
{
    public partial class ModificarDocumentoFamilia : Form
    {
        public string numero_documento;
        FamiliaController Negocio = new FamiliaController();
        ...
        public ModificarDocumentoFamilia(int id_archivo, int Id_Perfil, string User)
        {
            Usuario_Login = User;
            PerfilRol = Id_Perfil;
            InitializeComponent();
        ...
        {
            var load_Documento_Cargado = CargarDocumentos.ConsultarDocumentoFamiliaID(value);
        ...
        {
            var Load_TipoDocumentos = TipoDocumento.MostrarDocumentosFamiliaValue(tipo_documento);
        ...
        public void guardar()
        {
            ...
            validar_guardado = CargarDocumentos.ModificarDocumentosFamilia(EntidadDocumentos);
